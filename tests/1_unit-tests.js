...
suite("Basic Assertions", function () {
  ...
  test("#isOk, #isNotOk", function () {
    assert.isOk("I am truthy", "this is an optional message");
    assert.isNotOk(null, "this is an optional message");
  });

  // #4
  test("#isTrue, #isNotTrue", function () {
    assert.isTrue(true, "this is an optional message");
    assert.isNotTrue(1, "this is an optional message");
  });
});
...
suite("Comparisons", function () {
  ...
  test("#isBelow, #isAtLeast", function () {
    ...
    assert.isAbove(2 * Math.random(), 0); // Esto asegura que sea mayor que 0
